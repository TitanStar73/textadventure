...
while True:
    ...
    if situtation == 0:
        ...
        if choice == 'a':
            ...
            char_animation("You walk through the forest and see a stream.")
            char_animation(f"You walk along the stream and see a - {PAUSE*3}mermiad.")
            char_animation("You rub your eyes and look again - she is still there.")
            char_animation("You call out to her, 'hey!'.")
            char_animation("She looks at you frightened and swims away.")
            char_animation("The three of you chase after her and dive into the stream.")
            char_animation("You swim through the stream and reach a underwater cave.")
            char_animation("The mermaid is backed into a corner, she pleas: 'Please don't hurt me!'")
            char_animation(f"You say: 'I am {NAME}. We aren't here to hurt you. We are looking for the Dark Temple.'")
            char_animation("The mermaid gasps and says: 'The Dark Temple is a place of evil. You must not go there.'")
            char_animation("You say: 'We must, if we want to take down Marcor.'")
            char_animation("The mermaid looks at you and says: 'Very well. I will take you to our King.'")
            char_animation("You follow the mermaid through the underwater caves and reach a massive underwater palace!")
            char_animation("The palace is made of coral and blue turquoise shells. It is the most beautiful thing you have ever seen.")
            char_animation("In the center of the palace is a golden throne. On it sits a merman with a trident.")
            char_animation("He looks at you and asks the mermaid: 'Why have you brought them here?'")
            char_animation("The mermaid says: 'They are looking for the Dark Temple... They say they will defeat Marcor.'")
            char_animation("The merman looks at you and says: 'What makes you think you can defeat Marcor?'")
            char_animation("You say: 'We seek the Good King's armor. We believe it is in the Dark Temple.'")
            char_animation(f"Twilia chimes in: '{NAME} is the only one who can defeat Marcor - as the prophecy says only an outside saviour can save us'")
            char_animation(f"Igor adds on: 'Yes {NAME} is from another realm'")
            char_animation("\nThe merman looks at you and says: 'Marcor is the enemy of the mermaids'")
            char_animation("A century ago, we lived in peace with all other beings. But Marcor couldn't control us like he could control humans'")
            char_animation("So he drove us underground. We have been living here ever since.")
            char_animation("\nThe merman looks at you and says: 'Very well. I will help you.'")
            char_animation("He gives you instructions on how to reach the Dark Temple.")
